...
type User struct {
	...
	Email          string            `json:"email" gorm:"column:email;type:varchar(255);comment:用户邮箱"`
	...
	InvitedBy      string            `json:"invited_by" gorm:"column:invited_by;type:int;comment:被邀请用户ID"`
